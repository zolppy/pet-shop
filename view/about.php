...
<main style="min-height: calc(100dvh - 130px - 80px)">
  <section class="mt-[130px] p-4 flex flex-col gap-y-8">
    <h2 class="font-bold text-white text-2xl">Desenvolvedores</h2>
    <ul class="flex flex-wrap gap-4 justify-center">
      ...
      >
        ...
        <p class="text-[#C0C0C0]">
          ...
          <a
            href="https://www.eruda.com.br/"
            target="_blank"
            class="text-[#57C7FF]"
            >Eruda</a
          >, desenvolvedor IA AWS na
          <a
            ...
            >Compass UOL</a
          >
          e graduando em Licenciatura em Computação no
          <a
            href="https://portal.ifba.edu.br/jacobina"
            target="_blank"
            class="text-[#57C7FF]"
        ...
        <div class="flex gap-x-4 text-3xl justify-center">
          ...
          ></a>
          <a href="https://www.linkedin.com/in/zolppy" target="_blank"
      ...
      >
        ...
        <div class="flex gap-x-4 text-3xl justify-center">
          <a href="https://github.com/ruliancruz" target="_blank"
            ><i class="bi bi-github"></i
          ></a>
          <a href="https://www.linkedin.com/in/ruliancruz" target="_blank"
            ><i class="bi bi-linkedin"></i
          ></a>
        </div>
      </li>
