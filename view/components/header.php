...
>
  ...
  <ul class="flex min-w-[320px] w-[100%] max-w-[420px] sm:justify-end gap-x-2">
    <li>
      <a
        href="/pet-shop/"
        class="p-2 bg-inherit text-[#57C7FF] border border-[#57C7FF] transition-colors duration-200 rounded-lg hover:bg-[#57C7FF] hover:text-[#0D0D0D]"
        >Home</a
      >
    </li>
    <li>
