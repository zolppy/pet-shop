...
<html lang="pt-br">
  ...
  <body class="bg-[#1E1E2C] text-[#E0E0E0]">
    ...
    <main style="min-height: calc(100dvh - 130px - 80px)">
      ...
      <dialog>
        <div
          class="fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 p-4 flex flex-col gap-y-4 bg-transparent text-[#E0E0E0] backdrop-blur-xl min-w-[320px] w-[90%] max-w-[420px] rounded-lg border border-[#3D3D5C] sm:top-[55%]"
        >
